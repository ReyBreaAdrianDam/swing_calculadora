...
public class Calculadora extends JFrame{
    ...
    private final static JPanel PANEL_PRINCIPAL = new JPanel(new BorderLayout());
    private final static JPanel PANEL_TEXTO = new JPanel(new BorderLayout());
    private final static JPanel PANEL_BOTON = new JPanel(new GridLayout(TECLAS.length / 4,4));
